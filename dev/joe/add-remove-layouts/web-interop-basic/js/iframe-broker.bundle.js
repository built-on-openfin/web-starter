...
async function getSettings() {
    return {
        platform: {
            sharedWorkerUrl: "https://built-on-openfin.github.io/web-starter/dev/joe/add-remove-layouts/web-interop-basic/js/shared-worker.bundle.js",
            brokerUrl: "https://built-on-openfin.github.io/web-starter/dev/joe/add-remove-layouts/web-interop-basic/platform/iframe-broker.html",
