...
async function init() {
    return (0, iframe_broker_1.init)({
        sharedWorkerUrl: "https://built-on-openfin.github.io/web-starter/dev/john/v45-update-notifications-do-not-dismiss/web-layout-basic/js/shared-worker.bundle.js"
    });
}
init()
    .then(() => {
