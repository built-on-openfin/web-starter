...
async function init() {
    return (0, iframe_broker_1.init)({
        sharedWorkerUrl: "https://built-on-openfin.github.io/web-starter/dev/john/move-no-view-reload-example-to-45/web-layout-prevent-reload/js/shared-worker.bundle.js"
    });
}
init()
    .then(() => {
