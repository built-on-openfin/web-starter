...
/***/ "../../node_modules/@openfin/web-interop/out/iframe-broker.js":
/*!********************************************************************!*\
  !*** ../../node_modules/@openfin/web-interop/out/iframe-broker.js ***!
  \********************************************************************/
...
async function getSettings() {
    return {
        platform: {
            sharedWorkerUrl: "https://built-on-openfin.github.io/web-starter/dev/john/main-branch/web-interop-basic/js/shared-worker.bundle.js",
            brokerUrl: "https://built-on-openfin.github.io/web-starter/dev/john/main-branch/web-interop-basic/platform/iframe-broker.html",
...
/*!**********************************************!*\
  ...
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _openfin_web_interop_iframe_broker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @openfin/web-interop/iframe-broker */ "../../node_modules/@openfin/web-interop/out/iframe-broker.js");
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings */ "./client/src/platform/settings.ts");
...
async function init() {
    ...
    return (0,_openfin_web_interop_iframe_broker__WEBPACK_IMPORTED_MODULE_0__.init)({
