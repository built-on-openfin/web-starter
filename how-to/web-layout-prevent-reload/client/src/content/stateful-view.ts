 ...
 */
function applyRandomBackground(viewName: string): string {
 ...
 */
function recordLoad(viewName: string): number {
 ...
 */
function startUptime(element: HTMLElement): void {
...
function init(): void {
	...
	const nameElement = document.querySelector<HTMLElement>("#view-name");
	const colourElement = document.querySelector<HTMLElement>("#view-colour");
	const loadsElement = document.querySelector<HTMLElement>("#view-loads");
	const uptimeElement = document.querySelector<HTMLElement>("#view-uptime");
