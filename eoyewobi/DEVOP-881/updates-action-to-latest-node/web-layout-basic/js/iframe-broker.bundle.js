...
async function init() {
    return (0, iframe_broker_1.init)({
        sharedWorkerUrl: "https://built-on-openfin.github.io/web-starter/eoyewobi/DEVOP-881/updates-action-to-latest-node/web-layout-basic/js/shared-worker.bundle.js"
    });
}
init()
    .then(() => {
